...
/// Keys for Virtual Keyboard's rows.
const List<List> _keyRowsNumericWithoutDecimalPoint = [
  // Row 1
  const [
    '1',
    '2',
...
List<VirtualKeyboardKey> _getKeyboardRowKeysNumeric(
    rowNum, bool withoutDecimalPoint) {
  // Generate VirtualKeyboardKey objects for each row.
  if (withoutDecimalPoint) {
    return List.generate(_keyRowsNumericWithoutDecimalPoint[rowNum].length,
        (int keyNum) {
      // Get key string value.
      String key = _keyRowsNumericWithoutDecimalPoint[rowNum][keyNum];
...
List<List<VirtualKeyboardKey>> _getKeyboardRowsNumeric(
  ...
  return List.generate(_keyRowsNumeric.length, (int rowNum) {
    ...
    switch (rowNum) {
      case 3:
        // String keys.
        rowKeys.addAll(_getKeyboardRowKeysNumeric(rowNum, withoutDecimalPoint));
        ...
        break;
      default:
        rowKeys = _getKeyboardRowKeysNumeric(rowNum, withoutDecimalPoint);
    }
