...
class VirtualKeyboard extends StatefulWidget {
  ...
  /// me added
  final bool withoutDecimalPoint;
...
// me added
  // bool withoutDecimalPoint = false;
  ...
  List<Widget> _rows() {
    ...
    List<List<VirtualKeyboardKey>> keyboardRows =
        type == VirtualKeyboardType.Numeric
            ? _getKeyboardRowsNumeric(widget.withoutDecimalPoint)
            : _getKeyboardRows();
  ...
  Widget _keyboardDefaultKey(VirtualKeyboardKey key) {
    return Expanded(
      ...
      child: Container(
        height: height! / 4, //!!!!!!!!_keyRows.length,
        child: Center(
            child: Text(
          alwaysCaps
              ? key.capsText
